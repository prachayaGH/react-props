  ...
  return (
    <main>
      ...
      <div className="company-detail-right">
        ...
        <Button text="Learn More" buttonStyle="learn-button" />
      </div>
    </main>
  );
}
      ...
      <div className="product-section-container">
        ...
        <div className="product-card-list">
          <div className="product-card">
            ...
            <Button text="Add to Cart" buttonStyle="add-to-cart-button"/>
          </div>
          <div className="product-card">
            <img
              src="https://placehold.co/300x300"
          ...
          <div className="product-card">
            ...
            <Button text="Add to Cart" buttonStyle="add-to-cart-button-secondary"/>
          </div>
        </div>
      </div>
    </section>
